Public Class ColorPicker
    ...
    Private Sub inG_ValueChanged(sender As System.Object, e As System.EventArgs) Handles inG.ValueChanged
        If PassiveValueChange Then Exit Sub
        PassiveValueChange = True
        SetNewColor(Color.FromArgb(inA.Value, inR.Value, inG.Value, inB.Value))
        inH.Value = NewColor.GetHue
    ...
    Private Sub inB_ValueChanged(sender As System.Object, e As System.EventArgs) Handles inB.ValueChanged
        If PassiveValueChange Then Exit Sub
        PassiveValueChange = True
        SetNewColor(Color.FromArgb(inA.Value, inR.Value, inG.Value, inB.Value))
        inH.Value = NewColor.GetHue
    ...
    Private Sub inA_ValueChanged(sender As System.Object, e As System.EventArgs) Handles inA.ValueChanged
        If PassiveValueChange Then Exit Sub
        PassiveValueChange = True
        SetNewColor(Color.FromArgb(inA.Value, inR.Value, inG.Value, inB.Value))
    ...
    Private Sub PC1_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles PC1.Paint
    ...
    Private Sub PCA_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles PCA.Paint
    ...
    Private Sub pPrev_Paint(sender As System.Object, e As System.Windows.Forms.PaintEventArgs) Handles pPrev.Paint
    ...
    Private Sub ColorPicker_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
